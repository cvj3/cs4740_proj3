from common import *
from config import *
from parse_bigram import prepareUnitTestData, writeUnitTestFile, scoreUnitTestResults, readTestDataBaseline
...
if __name__ == "__main__":
    ...
    predictions_baseline = get_baseline_predictions(readTestDataBaseline("data", "large_unit_test.txt"))
